...
<head>
    ...
    <link href="{{ asset('backend/assets/toaster/toastr.min.css') }}" rel="stylesheet">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    @include('backend.inc.topbar-search')

                    <!-- Topbar Navbar -->
                    @include('backend.inc.topbar-navbar')
                </nav>
                <!-- End of Topbar -->
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('custom-auth/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('custom-auth/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('custom-auth/js/demo/chart-pie-demo.js') }}"></script>
